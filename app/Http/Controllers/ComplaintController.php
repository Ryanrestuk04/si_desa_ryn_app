...
class ComplaintController extends Controller
{
    public function index()
    {
        ...
        if (!$resident && Auth::user()->role_id == \App\Models\Role::ROLE_USER) {
            return redirect('/')->with('error', 'Akun Anda belum terhubung dengan data penduduk.');
        }

        $complaints = Complaint::when(Auth::user()->role_id == \App\Models\Role::ROLE_USER, function ($query) use ($resident) {
