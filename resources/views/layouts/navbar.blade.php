<nav class="navbar navbar-expand navbar-light bg-white topbar
 ...
 border-0 small" placeholder="Ketikan sesuatu..."
...
triangle text-white"></i>
                    ...
                    <div>
                        <div class="small text
gray-500">December 2, 2019</div>
                        Spending Alert: We've noticed unusually
                        high spending for your account.
                    </div>
                </a>
                <a class="dropdown-item text-center small text
gray-500" href="#">Show All
                    Alerts</a>
            </div>
        </li>
        <!-- Nav Item - Messages -->
...
center" href="#">
 ...
 asset('template/img/undraw_profile_1.svg') }}"
                            alt="...">
                        <div class="status-indicator bg
success"></div>
                    </div>
                    <div class="font-weight-bold">
                        <div class="text-truncate">Hi there! I
                            am wondering if you can help me with a
...
center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{
 asset('template/img/undraw_profile_2.svg') }}"
                            alt="...">
                        <div class="status-indicator"></div>
                    </div>
                    <div>
                        <div class="text-truncate">I have the
                            photos that you ordered last month, how
...
center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{
 asset('template/img/undraw_profile_3.svg') }}"
                            alt="...">
                        <div class="status-indicator bg
warning"></div>
                    </div>
                    <div>
                        <div class="text-truncate">Last month's
                            report looks great, I am very happy
                            with
...
gray-600 small">{{ auth()->user()->name }}</span>
