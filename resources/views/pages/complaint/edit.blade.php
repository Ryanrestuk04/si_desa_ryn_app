...
@section('content')
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Ubah Laporan</h1>
                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="content" id="content" cols="30" rows="10" class="form-control @error ('content') is-invalid @enderror">{{ old('content', $complaint->content) }}</textarea>
                                            @error('content')
                                                <span class="invalid-feedback">
                                                    {{ $message }}
                                                </span>
